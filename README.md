...
|-------|-------|-------------|
| `ui/` | React 18 + Vite, TypeScript, TanStack Router/Query, Tailwind + shadcn/ui, Recharts | Web client — dashboards, threat-intel databases, product/SBOM catalog. See [`ui/README.md`](ui/README.md). |
